    ...
    <footer className="relative overflow-hidden border-t border-[var(--color-luxury-ink)]/10 pt-32 pb-12">
      ...
      <div className="relative z-10 px-6 md:px-12 lg:px-20 xl:px-24 max-w-[100rem] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-24">
          <div className="col-span-1 md:col-span-2">
            ...
            <motion.p 
              ...
              className="text-sm opacity-70 max-w-xs leading-relaxed mb-8"
            >
            ...
            >
              {['Instagram', 'Pinterest', 'Journal'].map((social) => (
                <a key={social} href="#" className="text-[10px] uppercase tracking-widest border border-[var(--color-luxury-ink)]/20 px-4 py-2 rounded-none hover:bg-[var(--color-luxury-ink)] hover:text-[var(--color-luxury-bg)] transition-all duration-300">
                  {social}
                </a>
              ))}
            </motion.div>
        ...
        <motion.div 
          ...
          className="flex flex-col md:flex-row justify-between items-center gap-4 pt-8 border-t border-[var(--color-luxury-ink)]/10 text-[10px] uppercase tracking-widest opacity-50"
        >
